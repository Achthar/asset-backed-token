...
interface AssetBackedRequiemInterface extends ethers.utils.Interface {
  functions: {
...
export class AssetBackedRequiem extends BaseContract {
  ...
  interface: AssetBackedRequiemInterface;
